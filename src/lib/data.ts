...
export const students: Student[] = [
  ...
  { id: 'CS-004', firstName: 'John', lastName: 'Doe', department: 'CS', volunteerHours: 5, email: 'john@example.com', phone: '123-456-7890', parentEmail: 'parent.john@example.com', parentPhone: '098-765-4321' },
